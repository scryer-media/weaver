...
var ScenarioOnly = map[string]string{
	...
	"direct-store-demoted-dead-volume-settles": "stages the small direct-store PAR2 repair corpus and withholds an interior volume's articles past what the recovery set can rebuild",
	"dead-post-first-articles-missing":         "stages ten RAR volumes and their sidecars from two PAR2 corpora and withholds every article",
	"dead-post-recovery-unobtainable":          "stages par2-multivolume and withholds every article, recovery volumes included",
