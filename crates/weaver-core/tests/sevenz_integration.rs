...
use weaver_core::split_reader::SplitFileReader;
...
fn topology_single_7z() {
    ...
    assert!(matches!(
        ...
        weaver_assembly::ExtractionReadiness::Blocked { .. }
    ));

    // Set topology for single 7z.
    let topo = weaver_assembly::ArchiveTopology {
...
fn multi_set_readiness_partial() {
    ...
    let topo1 = weaver_assembly::ArchiveTopology {
        archive_type: weaver_assembly::ArchiveType::SevenZip,
