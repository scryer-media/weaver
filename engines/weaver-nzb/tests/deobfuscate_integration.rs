...
// ═══════════════════════════════════════════════════════════════════════════
// is_obfuscated — hashes and archive extensions
// ═══════════════════════════════════════════════════════════════════════════

#[test]
fn obfuscated_hex_hash_with_numeric_ext() {
    assert!(is_obfuscated("2c0837e5fa42c8cfb5d5e583168a2af4.mkv"));
}

#[test]
fn obfuscated_mixed_case_alphanum() {
    assert!(is_obfuscated("5KzdcWdGVGUG83Q9jv8KXht4O2k57w.mkv"));
}

#[test]
fn obfuscated_hex_dotted_chain() {
...
#[test]
fn not_obfuscated_par2_archive() {
    assert!(!is_obfuscated(
...
// ═══════════════════════════════════════════════════════════════════════════
// is_obfuscated — mixed tokens and clear release names
// ═══════════════════════════════════════════════════════════════════════════

#[test]
fn obfuscated_32_hex() {
    assert!(is_obfuscated("599c1c9e2bdfb5114044bf25152b7eaa.mkv"));
}

#[test]
fn obfuscated_short_mixed() {
    assert!(is_obfuscated("MUGNjK3zi65TtN.mkv"));
}

#[test]
fn obfuscated_caps_digits() {
    assert!(is_obfuscated("T306077.avi"));
}

#[test]
fn obfuscated_lowercase_mixed() {
    assert!(is_obfuscated("bar10nmbkkjjdfr.mkv"));
}

#[test]
fn obfuscated_very_long_mixed() {
    assert!(is_obfuscated(
...
#[test]
fn extract_par2_with_part_info() {
...
#[test]
fn extract_private_complex_filename() {
...
#[test]
fn extract_private_with_brackets_in_name() {
    let (name, _) = extract_filename(
...
#[test]
fn extract_private_numeric_segment_first() {
    let (name, _) =
...
#[test]
fn extract_private_dotless_filename() {
    let (name, _) =
...
#[test]
fn extract_private_with_n3wz_prefix() {
    let (name, _) = extract_filename(
...
#[test]
fn extract_private_encryptnzb_subsplease() {
    let (name, _) = extract_filename(
